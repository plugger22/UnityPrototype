...
public class SaveDataData
{
    ...
    public List<string> listOfScenarioNews = new List<string>();
    //TestLists
...
public class SaveActor
{
    ...
    public int numOfTimesReassured;
    public int numOfTimesPromised;
    ...
    public int numOfDaysUnhappy;
    public int numOfDaysLieLow;
    public int numOfDaysOnMap;
    public int numOfDaysReserves;
    public int numOfCities;
    public int numOfVotesFor;
    public int numOfVotesAgainst;
    public int numOfVotesAbstained;
    public int powerGainedAtHQ;
    public int powerLostAtHQ;
    ...
    public List<int> listOfPersonalityFactors = new List<int>();
    public List<string> listOfDescriptors = new List<string>();
    public List<HistoryOpinion> listOfMotivation = new List<HistoryOpinion>();
