...
/// </summary>
public class TabbedTopTabUI : MonoBehaviour, IPointerClickHandler
{
    ...
    public void SetTabIndex(int index, int max)
    {
        ...
        tabIndex = index;
        /*Debug.LogFormat("[Tst] TabbedTopTabUI.cs -> SetTabIndex: tabIndex {0}, maxTabIndex {1}{2}", tabIndex, maxTabIndex, "\n");*/
    }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        switch (eventData.button)
        {
            ...
            case PointerEventData.InputButton.Right:
                EventManager.i.PostNotification(EventType.TabbedOpenPage, this, tabIndex, "TabbedTopTabUI.cs -> OnPointClick");
                break;
        }
    }
