...
/// <summary>
/// handles mouse functionality for AI Display bottom tab (Hacking details and Alert Status)
/// </summary>
public class AIDisplayBottomTabMouseUI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        myCoroutine = StartCoroutine("ShowHackingTooltip");
    }
    ...
    /// </summary>
    /// <returns></returns>
    IEnumerator ShowHackingTooltip()
    {
