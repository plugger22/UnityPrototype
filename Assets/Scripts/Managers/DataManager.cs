...
public class DataManager : MonoBehaviour
{
    ...
    /// NOTE: Dismissed / Resigned actors will have their opinion set to Zero
    /// </summary>
    /// <param name="side"></param>
    /// <param name="actor"></param>
    /// <returns></returns>
            ...
            switch (status)
            {
                ...
                case ActorStatus.Dismissed:
                    if (AddActorToDismissed(actor.actorID, side) == true)
                    {
                        ...
                        actor.SetDatapoint(ActorDatapoint.Opinion1, 0, "Dismissed");
                ...
                case ActorStatus.Resigned:
                    ...
                    {
                        //actor movitation now Zero
                        actor.SetDatapoint(ActorDatapoint.Opinion1, 0, "Resigned");
    ...
    public Billboard GetRandomBillboard()
    {
        ...
        if (listOfBillboards != null)
        {
            countBillboard = listOfBillboards.Count;
            if (countBillboard == 0)
            {
                //reinitialise
                InitialiseBillboardList();
                countBillboard = listOfBillboards.Count;
            }
            if (countBillboard > 0)
            {
