...
public class TeamManager : MonoBehaviour
{
    ...
    {
        //set turnSide 
        GameManager.instance.turnScript.turnSide = SideEnum.Authority;
                ...
                if (team != null)
                {
                    ...
                    if (team.Timer < 0)
                    {
                        ...
                        if (node != null)
                        {
                            ...
                            Actor actor = GameManager.instance.dataScript.GetCurrentActor(team.ActorSlotID, SideEnum.Authority);
...
public void InitialiseTeams()
    {
        ...
        Actor[] arrayOfActors = GameManager.instance.dataScript.GetCurrentActors(SideEnum.Authority);
        ...
        if (team != null)
        {
            ...
            switch (destinationPool)
            {
                ...
                case TeamPool.OnMap:
                    ...
                    {
                        //Get Actor
                        Actor actor = GameManager.instance.dataScript.GetCurrentActor(actorSlotID, SideEnum.Authority);
                        if (actor != null)
                        {
    ...
    private void InitialiseGenericPickerRecall(int nodeID)
    {
        ...
        if (node != null)
        {
            ...
            if (listOfTeams != null && listOfTeams.Count > 0)
            {
                ...
                genericDetails.side = SideEnum.Authority;
        ...
        if (errorFlag == true)
        {
            ...
            outcomeDetails.side = SideEnum.Authority;
    ...
    private void InitialiseGenericPickerNeutralise(ModalActionDetails details)
    {
        ...
        if (node != null)
        {
            ...
            if (listOfTeams != null && listOfTeams.Count > 0)
            {
                ...
                genericDetails.side = SideEnum.Resistance;
        ...
        if (data.optionID > -1)
        {
            ...
            if (data.nodeID != -1)
            {
                ...
                if (team != null)
                {
                    ...
                    if (node != null)
                    {
                        Actor actor = GameManager.instance.dataScript.GetCurrentActor(data.actorSlotID, SideEnum.Resistance);
                        if (actor != null)
                        {
                            ...
                            details.sprite = sprite;
                            details.side = SideEnum.Resistance;
                            if (successFlag == true)
                            { details.isAction = true; }
                            EventManager.instance.PostNotification(EventType.OpenOutcomeWindow, this, details);
                        }
