namespace gameAPI
{
    ...
    public enum NodeColour { Default, Normal, Highlight, Active, Player, Nemesis, Background, Invisible, Count } //colour of node cylinder or district component (usually the base)
