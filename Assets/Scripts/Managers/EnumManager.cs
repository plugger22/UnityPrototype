namespace gameAPI
{
    ...
    public enum NodeColour { Default, Normal, Highlight, Active, Player, Nemesis, Background, Invisible, Transparent, TowerActive, Count } //colour of node cylinder or district component (usually the base)
