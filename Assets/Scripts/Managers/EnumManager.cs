namespace gameAPI
{
    ...
    // - - - Game Manager - - -
    //
    public enum GameState { None, MainMenu, StartUp, Options, NewGame, NewGameOptions, LoadGame, PlayGame, MetaGame, ExitLevel, ExitGame}  //overall game state
    ...
    public enum Background { None, Start, NewGame, NewGameOptions, Options, EndLevel, MetaGame }             //full screen backgrounds
