namespace gameAPI
{
    ...
    public enum NodeData { Stability, Support, Security, Target};        //NOTE: keep order as it is used in tooltipNode.cs -> GetStatColour (matches node tooltip stat display seq)
    public enum NodeUI
