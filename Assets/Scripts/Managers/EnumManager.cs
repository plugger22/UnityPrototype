namespace gameAPI
{
    ...
    //  - - - UI - - -
    //
    public enum ModalState { None, Outcome, GenericPicker, ActionMenu, Inventory, TeamPicker, DiceRoller, InfoDisplay, ShowMe }          //ModalUI sub game states
    ...
    public enum ActorInactive { None, LieLow, Breakdown, Leave}                             //reason actor is inactive
    ...
    public enum AITaskType { None, Team, Decision, Move, LieLow, StressLeave, Idle }                   //used for both AI Authority and Rebel sides. Not all options apply to each side.
