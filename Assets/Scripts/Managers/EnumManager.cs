namespace gameAPI
{
    ...
    public enum MsgPipelineType { None, CompromisedGear, Npc, Nemesis, CapturePlayer, ReleasePlayer, SecretRevealed, InvestigationLaunched, InvestigationCompleted, WinLoseLevel, WinLoseCampaign, DebugTopic} //see notes above
