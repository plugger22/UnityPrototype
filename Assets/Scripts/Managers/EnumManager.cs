namespace gameAPI
{
    ...
    // - - - Game Manager - - -
    //
    public enum GameState { None, MainMenu, StartUp, Options, NewGame, NewGameOptions, NewCampaign, LoadGame, PlayGame, MetaGame, ExitLevel, ExitCampaign, ExitGame}  //overall game state
