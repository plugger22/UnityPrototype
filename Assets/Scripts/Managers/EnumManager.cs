namespace gameAPI
{
    ...
    public enum TabbedPage { Main, Personality, History0, History1, Contacts, Secrets, Investigations, Likes }  //list of all possible pages (which ones vary by actorSet)
