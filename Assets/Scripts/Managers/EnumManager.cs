namespace gameAPI
{
    ...
    public enum AITaskType { None, Team, Decision, Move, LieLow, StressLeave, Idle, ActorArc, Target, Cure, Recruit, Faction, Count }  //used for both AI Authority and Rebel sides. Not all options apply to each side.
