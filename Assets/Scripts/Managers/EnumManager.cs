namespace gameAPI
{
    ...
    // - - - Game Manager - - -
    //
    public enum GameState { None, MainMenu, StartUp, Options, NewGame, LoadGame, PlayGame, MetaGame, ExitGame}                        //overall game state
    ...
    public enum Background { None, Start, NewGame, Options, End }             //full screen backgrounds
