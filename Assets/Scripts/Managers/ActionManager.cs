        ...
        if (node != null)
        {
            ...
            if (target != null)
            {
                ...
                if (roll < chance)
                {
                    ...
                    message = GameManager.instance.messageScript.GeneralRandom(text, chance, roll);
                    GameManager.instance.dataScript.AddMessage(message);
                }
                else
                {
                    ...
                    Message message = GameManager.instance.messageScript.GeneralRandom(text, chance, roll);
                    GameManager.instance.dataScript.AddMessage(message);
                }
                ...
                else
                {
                    ...
                    if (isZeroInvisibility == false)
                    {
                        ...
                        if (roll < failedTargetChance)
                        {
                            ...
                            Message message = GameManager.instance.messageScript.GeneralRandom(text, failedTargetChance, roll);
                            GameManager.instance.dataScript.AddMessage(message);
                        }
                        else
                        {
